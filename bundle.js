...
const addElements = () => {
    tripInfo.innerHTML += createTripInfo();
    tripNav.innerHTML += createMenu();
    tripControls.innerHTML += createTripFilters();
    tripEvents.innerHTML += createSort();
    tripEvents.innerHTML += createForm();
    tripEvents.innerHTML += createTripDay();
};
//Events
